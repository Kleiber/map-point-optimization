...
void System::SaveKeyFrameTrajectoryTUM(const string &filename)
{
    ...
    f.open(filename.c_str());
    f << fixed;
    std::cout<<"ID Keyframes within map :";
...
void System::SaveVisualOdometry(const string &filename)
{
    cout<<"           Saving Camera odometry ... ";
...
void System :: saveCloudPoint(const string &filename)
{
    cout<<"           Saving cloud points ... ";
...
void System :: saveOtherInformations(const string &filename)
{
    cout<<"           Saving others informations ... ";
    ...
    {
        f<<"Keyframes :"<<vpKFs.size()<<endl;
        f<<"MapPoints :"<<vpMPs.size()<<endl;
    }

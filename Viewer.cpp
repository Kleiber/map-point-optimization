...
/*
    ...
    pangolin::Var<bool> menuReconstruction("menu.Show Reconstruction", false, true);
...
*/
    ...
    while(1)
    {
        ...
        if(menuReconstruction){
            menuShowGraph = false;
            menuShowKeyFrames = false;
            menuShowPoints = false;

            mpMapDrawer->DrawReconstruction();
        }
